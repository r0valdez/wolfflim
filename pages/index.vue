<template>
  <div>
    ...
    <Modal v-if="showModal" @close-modal="showModal = false">
      <div class="video-container">
        <iframe
          width="560"
          height="315"
          src="https://www.youtube.com/embed/YOkPspMfPpQ"
    ...
    <div class="hero flex relative overflow-hidden">
      ...
      >
        <div class="video-wrapper">
          <iframe
            src="https://player.vimeo.com/video/655988012?background=1&autoplay=1&loop=1&byline=0&title=0"
            frameborder="0"
      ...
      >
        ...
        <div class="w-full flex flex-col justify-center items-center flex-grow">
          <svg
            ...
            class="filter drop-shadow-md max-w-4/5 mb-5 h-auto"
    ...
    <section class="bg-red-700 text-white px-4 md:px-6 py-6 clear-both">
      <div class="site-width clear-fix">
    ...
    <section class="text-white py-6 wolf-bg">
